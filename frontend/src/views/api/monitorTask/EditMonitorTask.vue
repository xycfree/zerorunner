<template>
  <div class="system-edit-menu-container">
    <el-dialog
        ...
        v-model="state.isShowDialog" width="60%">
      <el-row>
        <el-col :span="30" class="task-card">
          <el-card>
...
const saveOrUpdate = () => {
  ...
  //     state.form.case_env_id = caseEnvId
      ...
      useMonitorTasksApi().saveOrUpdate(state.form)
          .then(() => {
...
// checkCrontab
const checkCrontab = () => {
  useMonitorTasksApi().checkCrontab({crontab: state.form.crontab}).then((res) => {
